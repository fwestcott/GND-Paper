...
write.xlsx(Liver_fat_table, "Tables.xlsx", sheetName = "Liver fat", 
...
Insulin_medians <- pivot_longer(Insulin_medians[1:2,],
                                  cols = `IHTG (%)` : `GLY (mmol/L)`, 
                                  names_to = "Variable",
                                  values_to = "Median")
...
Insulin_mins <- pivot_longer(Insulin_mins[1:2,],
                                  cols = `IHTG (%)` : `GLY (mmol/L)`, 
                                  names_to = "Variable",
                                  values_to = "Minimum")
...
Insulin_maxs <- pivot_longer(Insulin_maxs[1:2,],
                                  cols = `IHTG (%)` : `GLY (mmol/L)`, 
                                  names_to = "Variable",
                                  values_to = "Maximum")
...
Insulin_table <- Insulin_medians
Insulin_table$Minimum <- Insulin_mins$Minimum
Insulin_table$Maximum <- Insulin_maxs$Maximum
Insulin_table <- Insulin_table[, c(2,1,3,4,5)]

Variables <- as_vector(Insulin_table[1:22,1])

Insulin_table <- Insulin_table[order(Insulin_table$`Insulin`, decreasing = TRUE),]
Insulin_table <- Insulin_table[order(Insulin_table$`Variable`),]

Insulin_table

write.xlsx(Insulin_table, "Tables.xlsx", sheetName = "Insulin", 
  col.names = TRUE, row.names = TRUE, append = TRUE)
